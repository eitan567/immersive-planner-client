      ...
      <div className="p-4 bg-[#fff4fc] rounded-lg">
        ...
        {isOpen && (
          <div className="space-y-4">
            <div ref={chatContainerRef} className={cn("h-[calc(100vh-520px)] overflow-y-auto border rounded-lg p-3 mt-2 space-y-3 bg-white scrollbar-thin scrollbar-track-transparent scrollbar-thumb-[#f2d8ff] hover:scrollbar-thumb-[#f2d8ff] scrollbar-thumb-rounded-md", className)}>
              {messages.length === 0 ? (
