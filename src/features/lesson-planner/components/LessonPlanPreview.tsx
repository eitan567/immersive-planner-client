  ...
  return (
    ...
    <h2 className={cn("pt-6 pb-3 text-2xl font-semibold text-[#fa4083]", className)}>תצוגה מקדימה - {lesson.topic}</h2>
        <AITextarea
          ...
          dir="rtl"
          className={cn("w-full min-h-[calc(100vh-250px)] text-right font-['Varela_Round'] text-[1.05rem] leading-7 bg-gray-50 p-6 rounded-lg border border-gray-100 text-gray-700 resize-y focus:outline-none focus:ring-1 focus:ring-blue-200 focus:border-blue-200 transition-all duration-200",aiClassName)}
          style={{ 
