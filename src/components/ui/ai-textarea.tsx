    ...
    return (
      <div className="relative w-full">
        <div className="flex w-full">
         <Textarea
           className={cn("w-full pl-[35px]", className)}
           ref={ref}
           value={value}
           onChange={onChange}
           {...props}
        ...
        {isOpen && (
          <div id="conversation" className={cn(
            ...
            isChatMode
              ? "fixed inset-x-[15%] top-[20%] bottom-[20%] w-[70%]"
                     ...
                     {messages.length === 0 ? (
                       ...
                       messages.map((message, index) => (
                         ...
                         >
                           ...
                           <div
                             className={`p-2 rounded-lg max-w-[90%] text-sm whitespace-pre-wrap break-words font-['Assistant'] ${
                               message.sender === 'user'
